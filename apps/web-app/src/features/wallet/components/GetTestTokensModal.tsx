  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-9999 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate__animated animate__fadeIn animate__faster">
        <div className="bg-[#1C1C1C] border border-[#229EDF]/40 rounded-2xl w-full max-w-md max-h-[85vh] overflow-y-auto shadow-2xl p-4 sm:p-5 animate__animated animate__fadeInUp animate__faster">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <Coins className="h-6 w-6 text-[#229EDF]" />
          ...
          <button
            ...
            disabled={isMinting}
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#229EDF]/40 bg-[#229EDF] px-4 py-3 text-sm font-semibold text-white transition-colors duration-150 hover:bg-[#1a8bc7] disabled:cursor-not-allowed disabled:opacity-50"
          >
