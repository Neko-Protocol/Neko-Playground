    ...
    <div className="flex items-center gap-3">
      ...
      <div className="relative w-9 h-6 shrink-0">
        <div className="absolute left-0 top-0 h-6 w-6 rounded-full border-2 border-[#1C1C1C] bg-[#1a2a4a] flex items-center justify-center">
          <Image
            src="/crypto/svg/stellar-xlm-logo.svg"
            alt={token1}
            width={14}
            height={14}
            unoptimized
        ...
        {tooltip && (
          <>
            ...
            {open &&
              ...
              createPortal(
                <div
                  className="pointer-events-none fixed z-[999999] w-56 rounded-lg bg-[#2A2A2A] px-3 py-2 text-sm text-white/80 shadow-xl"
                  style={{
                    left: pos.left,
                    top: pos.top,
...
const BorrowTable: React.FC = () => {
  ...
  return (
    <>
      <div className="w-full rounded-2xl overflow-x-hidden overflow-y-visible border border-white/5 bg-[#1C1C1C]">
