            ...
            {isLoading ? (
              ...
              pools.map((pool) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 align-middle text-center text-sm text-white">
                    {pool.roi}
                  </td>
                  <td className="px-4 py-4 align-middle text-center text-sm text-white">
                    {pool.liquidity}
                  ...
                  <td className="px-4 py-4 align-middle text-center">
                    <div className="flex items-center justify-center gap-2">
                      <button
                        ...
                        className="rounded-lg bg-[#2A2A2A] px-4 py-1.5 text-xs font-semibold text-white/70 transition-colors hover:bg-[#333] hover:text-white"
                      >
                        Deposit
                      </button>
                      <button
                        onClick={() => onWithdraw(pool)}
                        className="rounded-lg bg-[#229EDF] px-4 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-[#1a8bc7]"
                      >
                        Withdraw
                      </button>
                    </div>
