          ...
          <div className="relative z-10 mb-8">
            <div className="flex items-center gap-3 mb-4">
              <div className="relative w-16 h-10">
                <div className="absolute left-0 w-10 h-10 rounded-full bg-[#229EDF] border-2 border-white/10 flex items-center justify-center text-white text-sm font-bold shadow-md">
                  {token1[0]}
                </div>
                <div className="absolute left-8 w-10 h-10 rounded-full bg-[#229EDF]/60 border-2 border-white/10 flex items-center justify-center text-white text-sm font-bold shadow-md">
                  {token2[0]}
                </div>
              </div>
              <div>
