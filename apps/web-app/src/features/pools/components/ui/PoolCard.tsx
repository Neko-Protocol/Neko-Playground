...
export const PoolCard: React.FC<PoolCardProps> = ({
  ...
  <div className="rounded-3xl bg-neko-accent p-6 shadow-lg border border-neko-border/50 hover:border-neko-teal transition-all duration-300 hover:shadow-xl relative overflow-hidden group">
    ...
    <div
      className="relative z-10 bg-white rounded-2xl p-4 mb-4 border border-neko-border/30 hover:bg-neko-gray cursor-pointer transition-colors duration-200"
    ...
    {/* Action Buttons: Lend for lending pools */}
    {onLendClick != null && (
      <div className="relative z-10 flex">
        <button
          className="flex-1 bg-neko-navy hover:bg-neko-navy-hover text-neko-cream px-4 py-3 rounded-xl text-sm font-bold transition-colors duration-200 border border-neko-border/30"
          onClick={onLendClick}
        >
          Lend
        </button>
