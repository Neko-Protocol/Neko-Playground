...
JS library for interacting with [Soroban](https://soroban.stellar.org/) smart contract `lending` via Soroban RPC.
...
```js
import { Contract, networks } from "lending"
